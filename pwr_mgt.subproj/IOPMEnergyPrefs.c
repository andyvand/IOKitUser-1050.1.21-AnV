...
extern CFStringRef SCDynamicStoreKeyCreatePreferencesLocal(CFAllocatorRef allocator, CFStringRef prefsID, SCPreferencesKeyType keyType);
...
static IOReturn _doTouchEnergyPrefs(SCDynamicStoreRef ds)
{
    ...
    energyPrefsKey = SCDynamicStoreKeyCreatePreferencesLocal(NULL, kIOPMPrefsPath, kSCPreferencesKeyCommit);
    ...
    void *context) 
{
    ...
    EnergyPrefsKey = SCDynamicStoreKeyCreatePreferencesLocal(
                    NULL, 
                    kIOPMPrefsPath, 
