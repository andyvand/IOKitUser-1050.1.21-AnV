...
IOReturn IOPMCopyPowerHistoryDetailed(CFStringRef UUID, CFDictionaryRef *details)//CFArrayRef *outArray)
{
    ...
    *details = NULL;
    ...
    serializedData = CFGetDataFromFileURL(kCFAllocatorDefault, fileURL);
    ...
    details[0] = CFPropertyListCreateWithData(kCFAllocatorDefault, serializedData, 0, kCFPropertyListXMLFormat_v1_0, &error);
