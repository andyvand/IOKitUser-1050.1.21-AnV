...
/*static CFDataRef IOCFSerializeBinary(CFTypeRef object, CFOptionFlags options);*/
...
CFDataRef IOCFSerializeBinary(CFTypeRef object, CFOptionFlags options __unused);
