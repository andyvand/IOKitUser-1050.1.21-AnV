...
#define kIOHIDManagerUUIDKey "9B372B8E-67B6-4871-A2AA-FBEF7361535C"
#endif /* kIOHIDManagerUUIDKey */

#ifndef __IOHIDApplyPropertyToSetContext
typedef struct _IOHIDApplyPropertyToSetContext
{
    CFStringRef key;
    CFStringRef property;
} __IOHIDApplyPropertyToSetContext;
#endif /* __IOHIDApplyPropertyToSetContext */

#ifndef __IOHIDPropertyContext
typedef struct _IOHIDPropertyContext
{
...
extern void __IOHIDElementLoadProperties(IOHIDElementRef element);
...
extern CFStringRef __IOHIDManagerGetRootKey();
...
extern void __IOHIDPropertySaveWithContext(CFStringRef key, CFPropertyListRef value, __IOHIDPropertyContext *context);
extern void __IOHIDPropertySaveToKeyWithSpecialKeys(CFDictionaryRef dictionary, CFStringRef key, CFStringRef *specialKeys, __IOHIDPropertyContext *context);
extern void __IOHIDSaveElementSet(const void *value, void *context);
