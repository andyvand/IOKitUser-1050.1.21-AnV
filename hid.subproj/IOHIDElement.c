...
#ifndef __IOHIDDeviceGetUUIDKey
#define __IOHIDDeviceGetUUIDKey(D) (D)->UUIDKey
...
CFStringRef __IOHIDElementGetRootKey(IOHIDElementRef element)
{
    if (!element->rootKey) {
        ...
        CFStringRef device = (CFStringRef)__IOHIDDeviceGetUUIDKey(element->device);
...
#ifndef __IOHIDPropertySaveToKeyWithSpecialKeys
#define __IOHIDPropertySaveToKeyWithSpecialKeys(P,E,K,C) CFDictionaryAddValue(P,E,C)
#endif

#ifndef __IOHIDPropertyLoadFromKeyWithSpecialKeys
#define __IOHIDPropertyLoadFromKeyWithSpecialKeys(E,K) CFDictionaryCreateMutableCopy(kCFAllocatorDefault, element->properties, CFDictionaryGetCount(element->properties))
#endif
