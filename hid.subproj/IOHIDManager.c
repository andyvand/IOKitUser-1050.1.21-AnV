...
extern void __IOHIDManagerSaveProperties(IOHIDManagerRef manager, __IOHIDPropertyContext *context);
...
extern void __IOHIDApplyPropertiesToDeviceFromDictionary(const void *key, const void *value, void *context);
...
extern void __IOHIDDeviceSaveProperties(IOHIDDeviceRef device, __IOHIDPropertyContext *context);
