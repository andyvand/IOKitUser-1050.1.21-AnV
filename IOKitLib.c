...
readPlist( const char * path, UInt32 key __unused )
{
    ...
    if( data) {
        obj2 = CFPropertyListCreateWithData(kCFAllocatorDefault, data, kCFPropertyListMutableContainers, kCFPropertyListXMLFormat_v1_0, NULL);
        obj = CFDictionaryCreateMutableCopy(kCFAllocatorDefault, CFDictionaryGetCount(obj2), obj2);
...
writePlist( const char * path, CFMutableDictionaryRef dict, UInt32 key __unused )
{
    ...
    data = CFPropertyListCreateData(kCFAllocatorDefault, (CFDictionaryRef)dict, kCFPropertyListXMLFormat_v1_0, NULL, NULL);
