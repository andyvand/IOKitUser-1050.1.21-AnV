...
void IOMIGMachPortCacheAdd(mach_port_t port, CFTypeRef server)
{
    ...
    CFDictionarySetValue(__ioPortCache, (void *)(UInt64)port, server);
...
void IOMIGMachPortCacheRemove(mach_port_t port)
{
    ...
    CFDictionaryRemoveValue(__ioPortCache, (void *)(UInt64)port);
...
CFTypeRef IOMIGMachPortCacheCopy(mach_port_t port)
{
    ...
    server = (CFTypeRef)CFDictionaryGetValue(__ioPortCache, (void *)(UInt64)port);
