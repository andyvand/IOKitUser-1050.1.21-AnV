...
enum {
    kIOURLUnknownError 			= /*kCFURLUnknownError*/ -10,
    kIOURLUnknownSchemeError 		= /*kCFURLUnknownSchemeError*/ -11,
    kIOURLResourceNotFoundError 	= /*kCFURLResourceNotFoundError*/ -12,
    kIOURLResourceAccessViolationError 	= /*kCFURLResourceAccessViolationError*/ -13,
    kIOURLRemoteHostUnavailableError 	= /*kCFURLRemoteHostUnavailableError*/ -14,
    kIOURLImproperArgumentsError 	= /*kCFURLImproperArgumentsError*/ -15,
    kIOURLUnknownPropertyKeyError 	= /*kCFURLUnknownPropertyKeyError*/ -16,
    kIOURLPropertyKeyUnavailableError 	= /*kCFURLPropertyKeyUnavailableError*/ -17,
    kIOURLTimeoutError 			= /*kCFURLTimeoutError*/ -18
};
